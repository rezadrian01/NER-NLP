...
1. spaCy multilingual model (xx_ent_wiki_sm)
                ...
                <table class="comparison-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="{'better' if m1_data['exact_match']['precision'] > m2_data['exact_match']['precision'] else ''}">{m1_data['exact_match']['precision']:.4f}</td>
                            <td class="{'better' if m2_data['exact_match']['precision'] > m1_data['exact_match']['precision'] else ''}">{m2_data['exact_match']['precision']:.4f}</td>
                            <td class="{'diff-positive' if m1_data['exact_match']['precision'] - m2_data['exact_match']['precision'] > 0 else 'diff-negative'}">{m1_data['exact_match']['precision'] - m2_data['exact_match']['precision']:+.4f}</td>
                        </tr>
                        <tr>
                            <td>Exact Match Recall</td>
                            <td class="{'better' if m1_data['exact_match']['recall'] > m2_data['exact_match']['recall'] else ''}">{m1_data['exact_match']['recall']:.4f}</td>
                            <td class="{'better' if m2_data['exact_match']['recall'] > m1_data['exact_match']['recall'] else ''}">{m2_data['exact_match']['recall']:.4f}</td>
                            <td class="{'diff-positive' if m1_data['exact_match']['recall'] - m2_data['exact_match']['recall'] > 0 else 'diff-negative'}">{m1_data['exact_match']['recall'] - m2_data['exact_match']['recall']:+.4f}</td>
                        </tr>
                        <tr>
